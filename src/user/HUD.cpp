...
namespace P64::Script::CC5EE83BD620EE50
{
  P64_DATA(
    [[P64::Name("Image")]]
  ...
  void initDelete(Object& obj, Data *data, bool isDelete)
  {
    ...
    int posX = SCREEN_EDGE + conf.screenHeight+15;
    int posY = conf.screenHeight + SCREEN_EDGE - data->img.get()->height - conf.screenHeight;
  ...
  void draw(Object& obj, Data *data, float deltaTime)
  {
    ...
    if (User::ctx.canInteract) rspq_block_run(data->dplImg);
