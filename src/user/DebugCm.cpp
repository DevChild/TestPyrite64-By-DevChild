//UNA CAMARA DEBUG PARA PODER OBSERVAR LA ESCENA

/*
  Para que funcione se necesita crear un objeto camara y adjuntar a el este script
*/

#include "script/userScript.h"
#include "scene/sceneManager.h"

namespace P64::Script::C53F83731953DBCE
{
  P64_DATA(
